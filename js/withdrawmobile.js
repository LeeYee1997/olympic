...
//  axisBottom：axis with tick bottom-oriented，建立刻度线向下的轴，用yScale这个比例尺，保留15个tick(刻度线)
var xAxis = d3.axisTop(yScale).ticks(15);
...
//        yScale.domain(
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" + xScale(18) + " ," + yScale(-0.3) + ")")
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(0.3) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2000年");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(0.7) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("悉尼");
        ...
        svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(1.3) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2002");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(1.7) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("盐湖城");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(2.3) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2004");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(2.7) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("雅典");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(3.3) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2006");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(3.7) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("都灵");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(4.3) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2008");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(4.7) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("北京");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" + xScale(1.4) + " ," + yScale(5.3) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2010");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(5.7) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("温哥华");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(6.3) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2012");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(6.7) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("伦敦");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(7.3) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2014");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(7.7) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("索契");
    ...
    svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(8.3) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2016");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(8.7) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("里约");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(9.3) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2018");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(9.7) +")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("平昌");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(10.3) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2020");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(10.7) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("东京");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(11.3) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2022");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(11.7) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("北京");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(12.3) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2024");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(12.7) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("巴黎");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(13.3) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2026");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(13.7) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("待定");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(14.3) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("2028");
  ...
  svg.append("text")
    .attr("class", "xlabel")
    .attr("transform", "translate(" +  xScale(1.4) + " ," + yScale(14.7) + ")")
    .style("text-anchor", "middle")
    .style("font-size", "12px")
    .attr("dy", 0)
    .text("洛杉矶");
 ...
 svg.append("line")
  ...
  circles.attr("cx", function(d) {
      return xScale(+d.Unemployment); //把横轴数据，通过横轴比例尺yScale，得出每个circle应该对应的横轴位置
    })
    .attr("cy", function(d) {
      return yScale(+d.GDPgrowth);
    })
    .attr("r", 8)
    .attr("class",function(d){
      if (d.figure === "a") {
        if (d.Unemployment == "22") {
